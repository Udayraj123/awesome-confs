# Generated by Powerlevel10k configuration wizard on 2020-06-20 at 23:24 UTC.
...
() {
  ...
  function my_git_formatter() {
    ...
    if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
      ...
      # Add remote name too
      # where=$(git rev-parse --symbolic-full-name --abbrev-ref @{push})
  ...
  function prompt_git_push_remote() {
    local git_push_remote=$(git rev-parse --git-dir > /dev/null 2>&1 && git rev-parse --symbolic-full-name --abbrev-ref @{push} | cut -f 1 -d/);
    p10k segment -b blue -f white -i '🚀' -t "$git_push_remote"
  }
